...
func TestSlothdExport(t *testing.T) {
	db := dbm.NewMemDB()
	logger := log.NewTestLogger(t)
	gapp := NewSlothAppWithCustomOptions(t, false, SetupOptions{
	...
	newGapp := NewSlothApp(logger, db, nil, true, simtestutil.NewAppOptionsWithFlagHome(t.TempDir()), emptyWasmOpts)
