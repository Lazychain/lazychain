...
git checkout v0.1.9
just optimize
cp artifacts/ics721_base-aarch64.wasm ../interchaintest/test-artifacts/ics721_base.wasm
cd ..

cd cw-nfts
cargo make optimize
cp artifacts/cw721_base-aarch64.wasm ../interchaintest/test-artifacts/cw721_base.wasm