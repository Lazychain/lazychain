...
func TestMain(m *testing.M) {
	...
	execBinary := flag.String("binary", "slothd", "executable binary for server/ client side")
...
// ContractBech32Address build a slothd bech32 contract address
func ContractBech32Address(codeID, instanceID uint64) string {
	// copied from slothd keeper.BuildContractAddressClassic
