...
// SlothdCli wraps the command line interface
type SlothdCli struct {
	t              *testing.T
	nodeAddress    string
	chainID        string
	homeDir        string
...
// NewSlothdCLI constructor
func NewSlothdCLI(t *testing.T, sut *SystemUnderTest, verbose bool) *SlothdCli {
	return NewSlothdCLIx(
		t,
		sut.ExecBinary,
		sut.rpcAddr,
		sut.chainID,
...
// NewSlothdCLIx extended constructor
func NewSlothdCLIx(
	t *testing.T,
	execBinary string,
	nodeAddress string,
...
func (c SlothdCli) WithRunErrorsIgnored() SlothdCli {
...
func (c SlothdCli) WithRunErrorMatcher(f RunErrorAssert) SlothdCli {
	return *NewSlothdCLIx(
		c.t,
		c.execBinary,
		c.nodeAddress,
...
func (c SlothdCli) WithNodeAddress(nodeAddr string) SlothdCli {
	return *NewSlothdCLIx(
		c.t,
		c.execBinary,
		nodeAddr,
...
func (c SlothdCli) WithAssertTXUncommitted() SlothdCli {
	return *NewSlothdCLIx(
		c.t,
		c.execBinary,
		c.nodeAddress,
...
// CustomCommand main entry for executing slothd cli commands.
// When configured, method blocks until tx is committed.
func (c SlothdCli) CustomCommand(args ...string) string {
...
func (c SlothdCli) awaitTxCommitted(submitResp string, timeout ...time.Duration) (string, bool) {
...
// Keys slothd keys CLI command
func (c SlothdCli) Keys(args ...string) string {
	args = c.withKeyringFlags(args...)
	out, _ := c.run(args)
	return out
}

// CustomQuery main entrypoint for slothd CLI queries
func (c SlothdCli) CustomQuery(args ...string) string {
...
func (c SlothdCli) run(args []string) (output string, ok bool) {
	return c.runWithInput(args, nil)
}

func (c SlothdCli) runWithInput(args []string, input io.Reader) (output string, ok bool) {
	if c.Debug {
...
func (c SlothdCli) withQueryFlags(args ...string) []string {
	args = append(args, "--output", "json")
	return c.withChainFlags(args...)
}

func (c SlothdCli) withTXFlags(args ...string) []string {
	args = append(args,
		"--broadcast-mode", "sync",
		"--output", "json",
		"--yes",
...
func (c SlothdCli) withKeyringFlags(args ...string) []string {
	r := append(args,
		"--home", c.homeDir,
...
func (c SlothdCli) withChainFlags(args ...string) []string {
	return append(args,
		"--node", c.nodeAddress,
	)
}
...
func (c SlothdCli) WasmExecute(contractAddr, msg, from string, args ...string) string {
...
func (c SlothdCli) AddKey(name string) string {
...
func (c SlothdCli) AddKeyFromSeed(name, mnemoic string) string {
...
func (c SlothdCli) GetKeyAddr(name string) string {
...
func (c SlothdCli) FundAddress(destAddr, amount string) string {
...
func (c SlothdCli) WasmStore(file string, args ...string) int {
	if len(args) == 0 {
...
func (c SlothdCli) WasmInstantiate(codeID int, initMsg string, args ...string) string {
	if len(args) == 0 {
...
func (c SlothdCli) QuerySmart(contractAddr, msg string, args ...string) string {
...
func (c SlothdCli) QueryBalances(addr string) string {
	return c.CustomQuery("q", "bank", "balances", addr)
}

// QueryBalance returns balance amount for given denom.
// 0 when not found
func (c SlothdCli) QueryBalance(addr, denom string) int64 {
...
// 0 when not found
func (c SlothdCli) QueryTotalSupply(denom string) int64 {
	raw := c.CustomQuery("q", "bank", "total-supply")
	require.Contains(c.t, raw, "amount", raw)
	return gjson.Get(raw, fmt.Sprintf("supply.#(denom==%q).amount", denom)).Int()
}

func (c SlothdCli) GetCometBFTValidatorSet() cmtservice.GetLatestValidatorSetResponse {
...
func (c SlothdCli) IsInCometBftValset(valPubKey cryptotypes.PubKey) (cmtservice.GetLatestValidatorSetResponse, bool) {
...
func (c SlothdCli) SubmitGovProposal(proposalJson string, args ...string) string {
	if len(args) == 0 {
...
func (c SlothdCli) SubmitAndVoteGovProposal(proposalJson string, args ...string) string {
...
func (c SlothdCli) Version() string {
