...
replace (
	...
	// Necessary until better support for Rollkit is added to interchaintest
	github.com/strangelove-ventures/interchaintest/v8 => github.com/gjermundgaraba/interchaintest/v8 v8.0.0-20240508174758-4f9dee360813
